...
if abspath(PROGRAM_FILE) == @__FILE__
    ...
    open(joinpath(results_dir, "config.txt"), "w") do io
        ...
        println(io, "experiment: DC Motor, ODE_BUDGET=$(ode_budget), cosine LR")
        println(io)
    ...
    println("\n=== DC Motor: Targeted DADS Training (Reactant + Enzyme) ===")
    println("Target params: (k, J), Nuisance: (f, sigma)")
